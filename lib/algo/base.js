 ...
 */
export function digitStringToNumVals(digitString) {
 ...
 */
export function parseSingleNumericCheckChar(protectedString) {
 ...
 */
export function validateDecimalNumVals(numVals) {
    if (numVals.length === 0) {
 ...
 */
export class NumericCheckDigitAlgo {
